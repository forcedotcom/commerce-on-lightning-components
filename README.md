...
3.  Clone the repositoty `commerce/commerce-messaging-lightning-components`:

    ```shell
    git clone git@git.soma.salesforce.com:commerce/commerce-messaging-lightning-components.git
