...
const baseProductData = {
    ...
    expressPaymentUrl: 'https://www.phased-launch-testing.com/express',
    imageUrl:
...
// Product with variant definition missing lbl property to test variantId fallback
export const mockProductMissingVariantLabel = {
    ...baseProductData,
    imgGroups: [...defaultImageGroups, ...colorVariantImages],
    vattr: [
        {
            id: 'color',
            // Missing lbl property to trigger variantId fallback
            selected: 'JJ169XX',
            opts: [
                { val: 'JJ169XX', name: 'Black' },
                { val: 'JJI15XX', name: 'Blue' },
...
// Product with option missing name property to test variantValue fallback
export const mockProductMissingOptionName = {
    ...baseProductData,
    imgGroups: [...defaultImageGroups, ...colorVariantImages],
    vattr: [
        {
            ...
            selected: 'JJ169XX',
            opts: [
                { val: 'JJ169XX' }, // Missing name property to trigger variantValue fallback
                { val: 'JJI15XX', name: 'Blue' },
            ],
        },
        {
            ...
            lbl: 'Size',
            selected: 'M',
            opts: [{ val: 'M' }], // Missing name property to trigger variantValue fallback
        },
    ],
    vmat: [
        {
...
// Product with both missing lbl and missing option names to test both fallbacks
export const mockProductMissingBothFallbacks = {
    ...baseProductData,
    imgGroups: [...defaultImageGroups, ...colorVariantImages],
    vattr: [
        {
            ...
            opts: [
                { val: 'JJ169XX' }, // Missing name property to trigger variantValue fallback
                { val: 'JJI15XX' }, // Missing name property to trigger variantValue fallback
            ],
        },
        {
            id: 'size',
