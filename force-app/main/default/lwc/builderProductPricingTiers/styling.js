 ...
 */
export function generateStyleProperty(name, value, suffix) {
 ...
 */
export function generateStyleProperties(styles) {
    ...
    return styles
        .reduce((stylesList, style) => {
            const styleString = generateStyleProperty(style.name, style.value, style.suffix);
