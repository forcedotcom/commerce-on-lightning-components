...
import type {
    ...
    ProductCategoryPathData,
    ProductPricingCollectionResultData,
} from 'commerce/productApiInternal';
import type { SearchResultsPagination, SortRulesSearchResultsData } from 'commerce/searchApiInternal';
import * as SortRuleMockData from './sortRules.json';

const productSearchResultsData: ProductSearchResultsData = {
    categories: {
        category: {
...
export const mockSearchResultsData: ProductSearchResultSummary = {
    ...
    description: 'B2B_Search_Results_Tiles.multipleResultSearchHeaderShortWithIndex',
    categoryName: undefined,
};

export const mockSearchResultsDataDefault: ProductSearchResultSummary = {
    cardCollection: [],
    filtersPanel: {
        categories: {
            ancestorCategories: [],
...
export const getProductSearchData = (): ProductSearchResultsData => ({
    ...productSearchResultsData,
});

export const mockSortRulesSearchResultsData: SortRulesSearchResultsData = SortRuleMockData;

export const mockSearchPaginationData: SearchResultsPagination = {
    totalItemsCount: 10,
    startIndex: 1,
    endIndex: 5,
    totalPages: 2,
...
export const mockProductCategoryPathData: ProductCategoryPathData = {
    path: [{ description: null, id: '0ZGR00000000XqpOAE', name: 'Cereal' }],
};

export const mockProductPricingData: ProductPricingCollectionResultData = {
    currencyIsoCode: 'USD',
    pricingLineItemResults: [
        {
            error: {},
            listPrice: '2843',
            pricebookEntryId: '01txx0000006i63AAA',
            productId: '01txx0000006i63AAA',
            success: true,
            unitPrice: '2199',
        },
    ],
...
export const simpleSearchResultsData: ProductSearchResultsData = {
    productsPage: {
        currencyIsoCode: 'USD',
        products: [
            {
