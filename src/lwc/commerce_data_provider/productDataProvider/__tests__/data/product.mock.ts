...
import type { ProductInformationDetail } from 'types/productInformation';
...
variantMap.set('Nut-Mix_500g', { productId: '01tR0000000maX0IAI', attributes: ['Nut-Mix', '500g'] });
variantMap.set('Plain_500g', { productId: '01tR0000000maWlIAI', attributes: ['Plain', '500g'] });
variantMap.set('Nut-Mix_250g', { productId: '01tR0000000maWgIAI', attributes: ['Nut-Mix', '250g'] });
variantMap.set('Plain_250g', { productId: '01tR0000000maWVIAY', attributes: ['Plain', '250g'] });

const productDetail: ProductInformationDetail = {
    productClass: 'VariationParent',
    variants: [
        {
            id: '00NR0000001qQVy',
    ...
    selectedOptions: ['Nut-Mix', null, null],
    variantSelectionToProductIdMap: variantMap,
    name: 'Oat Flakes',
    identifier: '0123456789',
    descriptionContent: 'Cereals are great',
    categoryPath: [{ description: null, id: '0ZGR00000000XqpOAE', name: 'Cereal' }],
};

export const getProductDetailData = (
    variantNull = false,
    variantUndefined = false,
    hasAttributeInfo = true
): ProductDetailData => ({
    ...productDetailData,
    ...(variantUndefined || variantNull || !hasAttributeInfo
        ? {
              variationAttributeSet: undefined,
              mediaGroups: [],
          }
        : {}),
    ...(variantUndefined ? { variationInfo: undefined } : {}),
...
export const getProductDetail = (hasVariants = true, hasAttributeInfo = true): ProductInformationDetail => ({
    ...productDetail,
    ...(!hasVariants || !hasAttributeInfo ? { variants: [], selectedOptions: [] } : {}),
    ...(!hasAttributeInfo ? { variantSelectionToProductIdMap: new Map() } : {}),
    ...(!hasVariants ? { variantSelectionToProductIdMap: new Map() } : {}),
});
