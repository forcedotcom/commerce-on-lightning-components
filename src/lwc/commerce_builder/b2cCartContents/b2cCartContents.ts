 ...
 * @slot itemsBody ({ locked: false, defaultContent: [{ descriptor: "commerce_builder/cartItems", attributes: { showRemoveItem: true, showProductImage: true, showProductVariants: true, showPricePerUnit: true, showTotalPrices: true, showOriginalPrice: true, showActualPrice: true, showPromotions: true, showSku: false, productFieldMapping: "[{\"name\": \"ProductCode\",\"label\": \"Product Code:\",\"type\": \"STRING\"},{\"name\": \"Description\",\"label\": \"Description:\",\"type\": \"TEXTAREA\"}]" }}] })
 * @slot intermediateBody
 */
export default class B2cCartContents extends CartContents {
    /**
